                ...
                <form id="newSubCategory">
                    <div class="card-body">
                        <div class="form-group">
                            <input type="text" name="id" class="invisible" value="{{$subCategory->id}}"  >
                            <label for="name_ar">Name Arabic</label>
                            <input type="text" class="form-control" id="name_ar" name="name_ar" placeholder="Name Arabic" value="{{$subCategory->name_ar}}">
                            <small id="name_ar_error" class="form-text text-danger"></small>
                        </div>

                        <div class="form-group">
                            <label for="name_en">Name English</label>
                            <input type="text" class="form-control" id="name_en" name="name_en" placeholder="Name Arabic" value="{{$subCategory->name_en}}">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="category_id">
                                ...
                                <option @if($subCategory->category->id===$category->id) selected @endif value="{{$category->id}}">{{$category->name_en}}</option>
                                @empty
                                @endforelse
                            </select>
