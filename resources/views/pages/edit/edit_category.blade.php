    ...
    <section class="content">
        ...
        <div >
            ...
            <div class="card card-primary">
                ...
                <form id="newCategory">
                    <div class="card-body">
                        <input type="text" name="id" class="invisible" value="{{$category->id}}"  >
                        <div class="form-group">
                            <label for="name_ar">Name Arabic</label>
                            <input type="text" class="form-control" id="name_ar" name="name_ar" placeholder="Name Arabic" value="{{$category->name_ar}}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="name_en" name="name_en" placeholder="Name English" value="{{$category->name_en}}">
...
@section('scripts')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('.img-picker').imagePicker({name: 'image',src:"{{$category->image}}"});
        })
