                        ...
                        <table class="table table-hover text-nowrap">
                            ...
                            @forelse($subCategories as $subCategory)
                                <tr id="record_{{$subCategory->id}}">
                                    ...
                                    <td><div class="row">
                                            <div class="col">
                                                <button type="button" class="btn btn-block bg-gradient-success edit" value="{{$subCategory->id}}" >edit</button>
                                            </div>
                                            <div class="col">
                                                <button type="button" class="btn btn-block bg-gradient-danger delete"   value="{{$subCategory->id}}">Delete</button>
                                            </div>
                                        </div></td>
                                </tr>
                            @empty
...
@section('scripts')
    ...
    <script>
        ...
        $('.edit').click(function (e){
            ...
            var url = '{{ route("admin.editSubCategory", ":id") }}';
