...
@section('content')
    ...
    <section class="content">
        ...
        <a href="{{route('admin.addProductType')}}">
                        ...
                        <table class="table table-hover text-nowrap">
                            ...
                            <tbody>
                                ...
                                @forelse($productTypes as $productType)
                                    ...
                                    <td><div class="row">
                                            <div class="col">
                                                <button  class="btn btn-block bg-gradient-success edit" value="{{$productType->id}}" >edit</button>
                                            </div>
                                            <div class="col">
                                                <button  class="btn btn-block bg-gradient-danger delete"   value="{{$productType->id}}">Delete</button>
                                            </div>
                                        </div></td>
                                    </tr>
                                @empty
...
@section('scripts')
    ...
    <script>
        ...
        $('.edit').click(function (e){
            ...
            var url = '{{ route("admin.editProductType", ":id") }}';
        ...
        deleteBtn.onclick = function() {
            ...
            if(id>-1) {
                $.ajax({
                    type: 'post',
                    url: "{{route('admin.deleteProductType')}}",
                    data: 'id=' + id,
